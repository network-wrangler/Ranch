...
def test_step8_standard_format(request):
    ...
    with open(os.path.join(root_dir,"data", "interim","step8_shapes.geojson"), "w") as f:
        json.dump(shape_geojson, f)
    ...
    with open(os.path.join(root_dir,"data", "interim","step8_nodes.geojson"), "w") as f:
        json.dump(node_geojson, f)
    ...
    with open(os.path.join(root_dir,"data", "interim","step8_links.geojson"), "w") as f:
        json.dump(link_geojson, f)
